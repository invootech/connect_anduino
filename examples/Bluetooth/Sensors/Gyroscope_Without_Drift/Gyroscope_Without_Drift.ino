...
/*************************************************************
  This is the example of getting the Sensor value (Gyroscope without drift compensation)
  from the android app and performing desired task.
  
  Recieve the data and control you BOT, RC CAR or any Project using the
  Sensor feature (Gyroscope without drift compensation).
  See documentation for more details.

  Sensor Functions
  -- setGyroscope2() -> Sets listening to Gyroscope without drift compensation
...
void setup() {
   ...
   */
  sensor.begin(9600);
  sensor.setGyroscope2(); //Enables getting data for Gyroscope without drift compensation
}
