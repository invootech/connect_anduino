...
/*************************************************************
  This is the example of getting the Sensor value (Accelerometer excluding gravity)
  from the android app and performing desired task.
  
  Recieve the data and control you BOT, RC CAR or any Project using the
  Sensor feature (Accelerometer excluding gravity).
  See documentation for more details.

  Sensor Functions
  -- setAccelerometer2() -> Sets listening to Accelerometer excluding gravity
...
void setup() {
   ...
   */
  sensor.begin(9600);
  sensor.setAccelerometer2(); //Enables getting data for Accelerometer excluding gravity
}
