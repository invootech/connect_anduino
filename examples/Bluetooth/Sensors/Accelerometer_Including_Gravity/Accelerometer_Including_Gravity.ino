...
/*************************************************************
  This is the example of getting the Sensor value (Accelerometer including gravity)
  from the android app and performing desired task.
  
  Recieve the data and control you BOT, RC CAR or any Project using the
  Sensor feature (Accelerometer including gravity).
  See documentation for more details.

  Sensor Functions
  -- setAccelerometer() -> Sets listening to Accelerometer including gravity
...
void setup() {
   ...
   */
  sensor.begin(9600);
  sensor.setAccelerometer(); //Enables getting data for Accelerometer including gravity
}
