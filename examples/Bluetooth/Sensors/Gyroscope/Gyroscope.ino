...
/*************************************************************
  This is the example of getting the Sensor value (Gyroscope rate of rotation)
  from the android app and performing desired task.
  
  Recieve the data and control you BOT, RC CAR or any Project using the
  Sensor feature (Gyroscope rate of rotation).
  See documentation for more details.

  Sensor Functions
  -- setGyroscope() -> Sets listening to Gyroscope rate of rotation
...
void setup() {
   ...
   */
  sensor.begin(9600);
  sensor.setGyroscope(); //Enables getting data for Gyroscope rate of rotation
}
