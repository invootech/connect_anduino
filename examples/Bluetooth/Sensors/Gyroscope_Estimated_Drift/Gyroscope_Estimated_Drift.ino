...
/*************************************************************
  This is the example of getting the Sensor value (Gyroscope estimated drift)
  from the android app and performing desired task.
  
  Recieve the data and control you BOT, RC CAR or any Project using the
  Sensor feature (Gyroscope estimated drift).
  See documentation for more details.

  Sensor Functions
  -- setGyroscope3() -> Sets listening to Gyroscope estimated drift
...
void setup() {
   ...
   */
  sensor.begin(9600);
  sensor.setGyroscope3(); //Enables getting data for Gyroscope estimated drift
}
