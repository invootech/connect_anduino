...
/*************************************************************
  This is the example of getting the Sensor value (Rotation vector component)
  from the android app and performing desired task.
  
  Recieve the data and control you BOT, RC CAR or any Project using the
  Sensor feature (Rotation vector component).
  See documentation for more details.

  Sensor Functions
  -- setGravity() -> Sets listening to Rotation vector component
...
void setup() {
   ...
   */
  sensor.begin(9600);
  sensor.setVector(); //Enables getting data for Gravity
}
